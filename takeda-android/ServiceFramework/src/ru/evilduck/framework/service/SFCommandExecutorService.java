...
public class SFCommandExecutorService extends Service {
    ...
    public static final String ACTION_EXECUTE_COMMAND = SFApplicationState.getInstatce().getApplication().getPackageName().concat(".ACTION_EXECUTE_COMMAND");

    public static final String ACTION_CANCEL_COMMAND = SFApplicationState.getInstatce().getApplication().getPackageName().concat(".ACTION_CANCEL_COMMAND");

    public static final String EXTRA_REQUEST_ID = SFApplicationState.getInstatce().getApplication().getPackageName().concat(".EXTRA_REQUEST_ID");

    public static final String EXTRA_STATUS_RECEIVER = SFApplicationState.getInstatce().getApplication().getPackageName().concat(".STATUS_RECEIVER");

    public static final String EXTRA_COMMAND = SFApplicationState.getInstatce().getApplication().getPackageName().concat(".EXTRA_COMMAND");
