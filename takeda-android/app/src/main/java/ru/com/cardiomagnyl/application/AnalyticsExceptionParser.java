...
public class AnalyticsExceptionParser implements ExceptionParser {
    ...
    public String getDescription(String p_thread, Throwable p_throwable, String helpMessage) {
        return /*     */formatExceptionThread(p_thread) + //
                formatExceptionErrorMessage(Log.getStackTraceString(p_throwable)) + //
    ...
    private String formatExceptionErrorMessage(String exceptionErrorMessage) {
    ...
    private String getExceptionTime() {
        return "Time: " + getFormattedCurrentTime() + ";\n";
    }
