...
public class RiskAnalysisPatientDataFargment extends Ca_BaseItemFragment {
    ...
    private String pickTestIncomingFields(TestIncoming testIncoming) {
        ...
        SeekBarWithValues seekBarWithValuesCholesterol = (SeekBarWithValues) parentView.findViewById(R.id.seekBarWithValuesCholesterol);
        ...
        try {
            ...
            Integer cholesterolLevel = seekBarWithValuesCholesterol.getActualValue();
